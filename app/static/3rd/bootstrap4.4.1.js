/*!
  ...
  */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("app/static/3rd/popper1.16.0.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "app/static/3rd/popper1.16.0.js"], e) : e((t = t || self).bootstrap = {}, t.jQuery, t.Popper)
}(this, function (t, g, u) {
    "use strict";
            ...
            return t.toggle = function () {
                ...
                if (void 0 === t && (t = !1), !(this._element.disabled || g(this._element).hasClass(Ht) || g(this._menu).hasClass(Rt))) {
                    ...
                    if (g(i).trigger(n), !n.isDefaultPrevented()) {
                        if (!this._inNavbar && t) {
                            if ("undefined" == typeof u) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper1.16.0.js.org/)");
                            var o = this._element;
    ...
    var Ae = "tooltip", Ne = "bs.tooltip", Oe = "." + Ne, ke = g.fn[Ae], Pe = "bs-tooltip",
        ...
        ze = "manual", Xe = function () {
            function i(t, e) {
                if ("undefined" == typeof u) throw new TypeError("Bootstrap's tooltips require Popper.js (https://popper1.16.0.js.org/)");
